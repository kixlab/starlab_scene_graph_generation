...
def get_dataset_statistics(cfg):
    ...
    if os.path.exists(save_file) and not cfg.WSVL.USE_CAP_TRIP:
...
def make_data_loader(cfg, mode='train', is_distributed=False, start_iter=0):
    ...
    for dataset in datasets:
        ...
        print("cfg.TEST.CUSTUM_EVAL: ", cfg.TEST.CUSTUM_EVAL)
        if cfg.TEST.CUSTUM_EVAL:
            ...
            print('\n\n\n\n++++++++++++++++ ' + str(os.path.join(cfg.DETECTED_SGG_DIR, 'custom_data_info.json')) + ' SAVED !')
