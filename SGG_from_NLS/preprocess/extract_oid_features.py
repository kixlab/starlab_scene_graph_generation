...
if __name__ == '__main__':
    ...
    """
    ckpt_path = '/hdd/skchoi/SGG_from_NLS/preprocess/faster_rcnn_inception_resnet_v2_atrous_oid_v4_2018_12_12/frozen_inference_graph.pb'
    res_path = './_att'
    # img_path = '/media/user/4T/VL-BERT-master/data/conceptual-captions/cc_train_image'
    img_path = '/hdd/skchoi/SGG_from_NLS/preprocess/preprocess_data'
