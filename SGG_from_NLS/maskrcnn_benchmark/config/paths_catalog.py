...
class DatasetCatalog(object):
    ...
    def get(name, cfg):
        if "coco" in name:
            ...
            args['offline_OD_type'] = cfg.WSVL.OFFLINE_OD_TYPE
            args['use_cap_trip'] = cfg.WSVL.USE_CAP_TRIP
            args['caption_label_file'] = cfg.WSVL.CAP_TRIP_LABEL
